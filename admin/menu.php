...
<td>{$row['kat']}</td>
<td>{$Cl->cut_paragraph($row['text'])}...</td>
...
<td><a href='index.php?tabl1={$_GET['tabl']}&tabl={$_GET['tabl']}&udal={$row['id']}&view=menu'> <img width='50px' src='../images/admin/udalit.jpg'></a></td>
</tr>
";
}
