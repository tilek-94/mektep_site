...
<body style="padding:0px; margin:0px; background-color:#fff;font-family:arial,helvetica,sans-serif,verdana,'Open Sans'">
    ...
    <script src="slide/js/jssor.slider-27.5.0.min.js" type="text/javascript"></script>
...
?>
            ...
            <div>
                <img data-u="image" src="images/<? echo $row['img'];?>"/>
                <div data-u="caption" data-t="4" style="position:absolute;top:30px;left:30px;width:500px;height:40px;font-family:Oswald,sans-serif;font-size:32px;font-weight:200;line-height:1.2;text-align:center;background-color:rgba(255,188,5,0.8);"><? echo $row['title'];?></div>
            </div>
            <? endwhile;?>
